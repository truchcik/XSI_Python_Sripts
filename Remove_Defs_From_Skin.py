...
# oEnv.weights = nWts
# in Python above line doesnt work. oEnv.weights is treated as undefined instance,
# so unlike in vbscript or javascript, we need to change weights one by one:
